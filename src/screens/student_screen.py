...
from src.pipelines.face_pipeline import get_face_embeddings, predict_attendence, train_classifier
...
from src.database.db import get_all_students,create_student,get_student_subjects,get_student_attendence,unenroll_student_to_subjects
import time
        ...
        with st.spinner("AI is scanning.."):
            ...
            if num_faces == 0:
                ...
                if detected:
                    ...
                    st.info("Face not recogined! You might be a new student!")
                ...
                if new_name:
                    with st.spinner("Create Profile...."):
                        ...
                        if encodings:
                            ...
                            st.warning("Couldnt capture your facial features for registration")
